 ...
 **Solution:**
 ...
 Now, draw a picture.
(ref:NHANES6d-density-cap) Density Plot of Pulse Rate of a person

```{r NHANES6d-density, warning=FALSE, echo=FALSE, fig.cap="(ref:NHANES6d-density-cap)"}
gf_density(~Pulse, data=NHANES)
```
...
### Example: Sampling Distribution
 ...
 The NHANES data frame has the pulse rates for approximately 50,000 individuals. The random variable is *x* = pulse rate. The probability distribution of this random variable is presented in (Figure \@ref(fig:NHANES6h-density). Although pulse rates from 50,000 individuals isn't the entire population, the sample is most likely a good representation of the population. Thus, it is safe to assume the population is normally distributed. An estimate for the population mean is 73.6 pbm, and the population standard deviation estimated at is 12.2 bpm. 
