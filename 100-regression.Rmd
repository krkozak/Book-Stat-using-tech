...
>
> ![](media/image1.emf){width="4.138888888888889in"
...
**Figure \#10.1.2: Scatter Plot of Beer Data with Regression Line and
Residuals**

![](_media/image-10-2.jpg){width="5.083333333333333in"
height="5.083333333333333in"}

**The find the regression equation (also known as best fitting line or
least squares line)**

Given a collection of paired sample data, the regression equation is

where the slope = and *y*-intercept =
...
subscript *xy*, you aren't really summing squares, but you can think of
...
> **Table \#10.1.2: Alcohol and Calorie Content in Beer without
> Outlier**
...
>
> To find the regression equation on the TI-83/84 calculator, put the *x*'s in L1 and the *y*'s in L2. Then go to STAT, over to TESTS, and choose LinRegTTest. The setup is in figure \#10.1.3. The reason that \>0 was chosen is because the question was asked if there was a positive relationship. If you are asked if there is a negative relationship, then pick \<0. If you are just asked if there is a relationship, then pick . Right now the choice will not make a different, but it will be important later.
>
> **Figure \#10.1.3: Setup for Linear Regression Test on TI-83/84**
>
> ![](media/image15.png){width="2.75in" height="1.8611111111111112in"}
>
> **Figure \#10.1.4: Results for Linear Regression Test on TI-83/84**
>
> ![](media/image16.png){width="2.75in"
> height="1.8611111111111112in"}![](media/image17.png){width="2.75in"
...
To find the residuals, find for each *x*-value. Then subtract each from the given *y* value to find the residuals. Realize that these are sample residuals since they are calculated from sample values. It is best to do this in a spreadsheet.
...
lm.out = lm(dependent variable \~ independent variable) -- this defines
...
The graph of the residuals versus the *x*-values is in figure \#10.1.5.
They appear to be somewhat random.

**Figure \#10.1.5: Residuals of Beer Calories versus Content**

> ![](media/image26.emf){width="3.5972222222222223in"
...
**Example \#10.1.3: Calculating the Regression Equation with the
Formula**
...
**Table \#10.1.4: Calculations for Regression Equation**
  ...
  5.516667          170.2222                        12.45    10335.5556   327.6667
...
1.  When an anthropologist finds skeletal remains, they need to figure
...
2.  Table \#10.1.6 contains the value of the house and the amount of
...
3.  The World Bank collects information on the life expectancy of a
...
4.  The World Bank collected data on the percentage of GDP that a
...
5.  The height and weight of baseball players are in table \#10.1.9
...
6.  Different species have different body weights and brain weights are
...
7.  A random sample of beef hotdogs was taken and the amount of sodium
...
8.  Per capita income in 1960 dollars for European countries and the
...
> **Table \#10.1.12: Percent of Labor in Agriculture and Per Capita
...
9.  Cigarette smoking and cancer have been linked. The number of deaths
...
10. The weight of a car can influence the mileage that the car can
...
![](media/image42.png){width="6.0in" height="3.762431102362205in"}
...
>
> To compute the correlation coefficient using the TI-83/84 calculator, use the LinRegTTest in the STAT menu. The setup is in figure 10.2.2. The reason that \>0 was chosen is because the question was asked if there was a positive correlation. If you are asked if there is a negative correlation, then pick \<0. If you are just asked if there is a correlation, then pick . Right now the choice will not make a different, but it will be important later.
>
...
>
> ![](media/image52.png){width="2.75in" height="1.8611111111111112in"}
> ![](media/image53.png){width="2.75in" height="1.8611111111111112in"}
>
...
**Example \#10.2.4: Using the Formula to Calculate *r* and **
...
>
> ![](media/image102.png){width="2.75in" height="1.8611111111111112in"}
>
> The *s* in the results is the standard error of the estimate. So .
...
Given the fixed value , the prediction interval for an individual *y* is
...
lm.out = lm(dependent variable \~ independent variable) -- calculates
the linear model
...
>
> ![](media/image114.png){width="2.75in" height="1.8611111111111112in"}
>
> Now you can find
>
...
**Example \#10.3.5:  Doing a Correlation and Regression Analysis Using
the TI-83/84**

Table \#10.3.1 contains randomly selected high temperatures at various
cities on a single day and the elevation of the city.

> **Table \#10.3.1: Temperatures and Elevation of Cities on a Given
> Day**
...
b.  Find a regression equation for elevation and high temperature on a
    given day.
...
b.  The distribution for each high temperature value is normally
...
iii. The residual plot for temperature versus elevation appears to be
...
>
> **Figure \#10.3.5: Setup for Linear Regression on TI-83/84
> Calculator**
>
...
> **Figure \#10.3.6: Results for Linear Regression on TI-83/84
> Calculator**
>
...
d.  Use the regression equation to estimate the high temperature on that
    day at an elevation of 5500 ft.

> **Solution:**

e.  Use the regression equation to estimate the high temperature on that
    day at an elevation of 8000 ft.

> **Solution:**

f.  Between the answers to parts d and e, which estimate is probably
...
g.  Find the correlation coefficient and coefficient of determination
    and interpret both.
...
h.  Is there enough evidence to show a negative correlation between
...
j.  Using a 95% prediction interval, find a range for high temperature
...
>
> ![](media/image143.png){width="2.75in" height="1.8611111111111112in"}
>
> Now you can find
>
...
**Example \#10.3.6:  Doing a Correlation and Regression Analysis Using
R**
...
>
> ![](media/image151.emf){width="4.152777777777778in"
> height="4.152777777777778in"}
>
> The scatter plot looks fairly linear.

ii. The residual plot for temperature versus elevation appears to be
...
![](media/image154.emf){width="2.5277777777777777in"
...
*Calories in beer, beer alcohol, beer carbohydrates*. (2011, October
25). Retrieved from
[www.beer100.com/beercalories.htm](http://www.beer100.com/beercalories.htm)
