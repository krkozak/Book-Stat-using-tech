...
**Code book for data frame Mercury** See Homework problem 7.3.3 in section 7.3
 ...
 4.  The data frame Pulse (Table 8.3.8) contains various variables about a person including their pulse rates before the subject exercised and after after the subject ran in place for one minute. Estimate the mean pulse rate of females who do drink alcohol with a 95% level of confidence? 
