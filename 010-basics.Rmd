...
**Population** -- set of all values of the variable for the entire group of unit of observations.
...
then select every *k*th unit of observation to measure.
...
**Blind study** is where the unit of observation does not know which treatment they are getting or if they are getting the treatment or a placebo.

**Double-blind study** is where neither the unit of observation nor the
